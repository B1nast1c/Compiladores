...
from Generador import crearArch, cerrarE
from Generador import crearSum
...
#PRUEBA PARA SUM EMSAMBLADOR
def generarEns(e):
  lista = e
  while len(lista) > 1:
    if lista[1][1] == '+':
      crearSum(lista[0][1],lista[2][1])
      lista[2][1]=lista[0][1]+lista[2][1]
