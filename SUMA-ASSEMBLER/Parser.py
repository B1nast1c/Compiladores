...
def parsing():
  entrada = return_tokens('Prueba5.txt') #Lectura de archivos

  df = pd.read_csv('tablaFIN.csv', index_col=0) #Lectura de tablas
...
def Syntax(entrada): #Función a usarse en las próximas fases del compilador
